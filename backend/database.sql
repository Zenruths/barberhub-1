...
-- Copiando dados para a tabela edenerp.clientesbkp: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela edenerp.profissionais: ~3 rows (aproximadamente)
...
-- Copiando dados para a tabela edenerp.user_login_logs: ~54 rows (aproximadamente)
INSERT INTO `user_login_logs` (`id`, `user_id`, `username`, `email`, `ip_address`, `device_info`, `login_time`, `logout_time`, `success`, `user_agent`) VALUES
	...
	(54, 1, 'Rafa', 'rafaelzenruths@gmail.com', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36', '2026-01-19 23:22:18', NULL, 1, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36');
...
-- Copiando dados para a tabela edenerp.user_refresh_tokens: ~53 rows (aproximadamente)
INSERT INTO `user_refresh_tokens` (`id`, `user_id`, `token_hash`, `created_at`, `last_used_at`, `expires_at`, `revoked`) VALUES
	...
	(52, 1, '$2a$10$rlAPDgOQr3Sf2ArHm8Jq.uzgGltAp2CLMPL1PfLasw2hrmp6MkwVS', '2026-01-18 23:33:02', '2026-01-18 23:33:02', '2026-01-19 00:03:02', 1),
	(53, 1, '$2b$10$Gfz70N0JDup/xbticX/qd.7cr13/cnHc/Bh.xD1tAKG8YPPsJr/Q.', '2026-01-19 20:22:18', '2026-01-19 21:33:35', '2026-01-19 22:03:35', 0);
...
-- Copiando dados para a tabela edenerp.usuarios: ~5 rows (aproximadamente)
INSERT INTO `usuarios` (`id`, `username`, `email`, `password_hash`, `created_at`) VALUES
	...
	(5, 'teste2', 'teste2@teste.com', '$2b$10$bRDkjlg1mrSFjMVKvK/6d.sgjObCsntdzxP6AAd8C/tFJ/T7PriFi', '2026-01-19 23:27:31');
